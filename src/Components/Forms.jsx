...
function UploaderUpdateImagePost() {
    ...
    return (
        <article>
            <div
                onClick={
                    () => document.querySelector('.inptuImageUpdatePost').click()
                }
                ...
                <input
                    ...
                    type="file" accept="image/*" className="inptuImageUpdatePost" hidden />
                {
                    image ?
                        <img
...
export function FormUpdatePost({ handleClose, OnUpdatePost, Id }) {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.put(`http://localhost:1234/post/${Id}`, data, {
            headers: {
    ...
    return (
        <form onSubmit={handleSubmit} >
            ...
            {
                isSending ? <Spinner label="Loading..." className=" m-auto" color="primary" labelColor="primary" /> : null
            }
